<template>
    <div class="container">
        <div class="nav-container">
            <Nav showBackArrow="true" showText="true" navText="我被回覆的評論" destination="Mycomment" v-if="this.$store.state.read_mode=='MyReceiveComment'"/>
            <Nav showBackArrow="true" showText="true" navText="查看他人日記" destination="MoodTree" v-else/>
        </div>
        <!--發文者資訊-->
        <div class="author">
